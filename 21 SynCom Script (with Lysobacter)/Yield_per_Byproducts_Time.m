...
Name_file = 'data_to_save_SynCom21_Soil_only_Lyso_Parfor_Newv4';%'struct_tot_SynCom21_Soil_only_Lyso_Parfor';%'data_to_save_SynCom21_Soil_only_Lyso_Parfor_7';%'data_to_save_SynCom21_Soil_only_Lyso_Parfor_Random';%'data_to_save_Inter_v2';%'data_no_CF.mat';
...
Time_step_BP = 0:50:1500; %Definition of a time step for the byproduct visualization
name = string(table2array(Parameters_set(1:21,1)));
name(end - 1:end) = [{'Ps1'}, {'Ps2'}];

%Load parameters
load(strcat('Data/', Name_file));
data_to_save = data_to_save_SynCom21_Soil_only_Lyso_Parfor_Newv4;%struct_tot_SynCom21_Soil_only_Lyso_Parfor;%data_to_save_SynCom21_Soil_only_Lyso_Parfor_7;%data_to_save_SynCom21_Soil_only_Lyso_Parfor_Random;%data_to_save_Inter_v2;%data_no_CF;
