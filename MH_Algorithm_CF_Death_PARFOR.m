...
data_to_save_with_corrections_2 = struct();
...
for nb_iter_tot = 1:1
    ...
    data_to_save_with_corrections_2(nb_iter_tot).CrossFeed_Mat_Temp = CrossFeed_Mat_Temp;
    data_to_save_with_corrections_2(nb_iter_tot).Threshold_CF = Threshold_CF;
    data_to_save_with_corrections_2(nb_iter_tot).Threshold_death = Threshold_death;
    data_to_save_with_corrections_2(nb_iter_tot).Death_Mat_Temp = Death_Mat_Temp;
    data_to_save_with_corrections_2(nb_iter_tot).Resource_Matrix = Resource_Matrix;
    data_to_save_with_corrections_2(nb_iter_tot).Lag_time_Pred = Lag_time_Pred;
    data_to_save_with_corrections_2(nb_iter_tot).Lag_time_Cons = Lag_time_Cons;
    data_to_save_with_corrections_2(nb_iter_tot).Mat_kappa_3 = Mat_kappa_3;
    data_to_save_with_corrections_2(nb_iter_tot).kappa_mat = kappa_mat;
    data_to_save_with_corrections_2(nb_iter_tot).R = R;
    data_to_save_with_corrections_2(nb_iter_tot).CrossFeed_Mat_init = CrossFeed_Mat_init;
    data_to_save_with_corrections_2(nb_iter_tot).Threshold_CF_init = Threshold_CF_init;
    data_to_save_with_corrections_2(nb_iter_tot).Threshold_death_init = Threshold_death_init;
    data_to_save_with_corrections_2(nb_iter_tot).Death_Mat_init = Death_Mat_init;
    data_to_save_with_corrections_2(nb_iter_tot).Resource_Matrix_init = Resource_Matrix_init;
    data_to_save_with_corrections_2(nb_iter_tot).Lag_time_Pred_init = Lag_time_Pred_init;
    data_to_save_with_corrections_2(nb_iter_tot).Lag_time_Cons_init = Lag_time_Cons_init;
    data_to_save_with_corrections_2(nb_iter_tot).Mat_kappa_3_init = Mat_kappa_3_init;
    data_to_save_with_corrections_2(nb_iter_tot).kappa_mat_init = kappa_mat_init;
    data_to_save_with_corrections_2(nb_iter_tot).R_init = R_init;
    data_to_save_with_corrections_2(nb_iter_tot).Struct_Res_Mat = Struct_Res_Mat;
    data_to_save_with_corrections_2(nb_iter_tot).Struct_Death_Mat = Struct_Death_Mat;
    data_to_save_with_corrections_2(nb_iter_tot).Struct_CrossFeed_Mat = Struct_CrossFeed_Mat;
    data_to_save_with_corrections_2(nb_iter_tot).Cov_Mat_CF = Cov_Mat_CF;
    data_to_save_with_corrections_2(nb_iter_tot).Cov_Mat_Death = Cov_Mat_Death;
    data_to_save_with_corrections_2(nb_iter_tot).Cov_Mat_Res = Cov_Mat_Res;
    data_to_save_with_corrections_2(nb_iter_tot).Cov_Mat_LT = Cov_Mat_LT;
    data_to_save_with_corrections_2(nb_iter_tot).death_rate = death_rate;
end

save(strcat(cd, '/Data/', 'data_to_save_with_corrections_2'), 'data_to_save_with_corrections_2')